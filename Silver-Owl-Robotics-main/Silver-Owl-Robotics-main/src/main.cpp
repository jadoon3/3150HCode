...
int DriveTask(void){
  ...
  {
    EXIT=true;
    RV=-Controller1.Axis2.position(percent);
    LV=-Controller1.Axis3.position(percent);
    Move(LV,RV);
  }
...
int ATask(void)
{
    ...
    while(true)
  {
    ...
    else if (RTaskActiv==1&&!Controller1.ButtonR1.pressing())
    { 
      IntakeBoth(-100);  
    }
    else if (R2TaskActiv==1&&!Controller1.ButtonR2.pressing())
    {
      IntakeBoth(100);
    }
...
int PTask(void)
{
    ...
    //----------------------
      //Toggles Clamp
    if(YTaskActiv==0&&Controller1.ButtonUp.pressing()&&ButtonPressingY==0)
    {
      ButtonPressingY=1;
      YTaskActiv=1;
      Clamp.set(true);
    ...
    else if(YTaskActiv==1&&Controller1.ButtonUp.pressing()&&ButtonPressingY==0)
    {
      ButtonPressingY=1;
      YTaskActiv=0;
      Clamp.set(false);
